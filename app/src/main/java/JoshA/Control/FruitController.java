...
public class FruitController{
    ...
    @GetMapping(path = "/Fruit/{A1}", produces = "application/json")
    public ResponseEntity<Object> getFruit(@PathVariable("A1") Integer A1){
        
        if(A1==3){
            //If the value of Integer found in request path is 3
            throw new FruitNotFoundException();
            //Throw my customized FruitNotFoundException
        }
        
        if(A1==2){
            //If the value of Integer found in request path is 2
            throw new FruitNotAccessible();
            //Throw my customized FruitNotAccessible
        }
...
//To test the my FruitNotFoundException Exception:
//Browser: http://localhost:9090/JoshFruit/Fruit/3
//THE ABOVE IS FOR .getFruit()


//To test the my FruitNotAccessible Exception:
//Browser: http://localhost:9090/JoshFruit/Fruit/2
//THE ABOVE IS FOR .getFruit()

//To Normally send a GET request without any exception;
//Browser: http://localhost:9090/JoshFruit/Fruit/1
//THE ABOVE IS FOR .getFruit()
